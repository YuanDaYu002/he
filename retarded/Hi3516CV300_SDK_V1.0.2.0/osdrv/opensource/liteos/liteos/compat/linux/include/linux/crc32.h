 ...
 * </ul>
 *
 * @param  crc32val [IN/OUT] Type #UINT32  the result of  crc32 calculation.
 ...
 *
 * @retval UINT32 return the crc value.
 * @par Dependency:
 * <ul><li>Crc32.h: the header file that contains the API declaration.</li></ul>
 * @see none.
 * @since Huawei LiteOS V100R001C00
 */
extern unsigned int crc32_accumulate(UINT32 crc32val, unsigned char *s, int len);
