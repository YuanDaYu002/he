...
#define in_interrupt()        (OS_INT_ACTIVE)
 ...
 */
extern UINT64 div64_u64(UINT64 dividend, UINT64 divisor);
  /**
 * @ingroup  linux_kernel
 * @brief do division implimentation.
 *
 ...
 * @since Huawei LiteOS V200R001C00
 */
extern INT64 div64_s64(INT64 dividend, INT64 divisor);
...
static inline int misc_register(struct miscdevice * misc)
{
    return 0;
}
