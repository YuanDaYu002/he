 ...
 * @attention
 * <ul>
 * <li>The parameter ptimer must be valid, otherwise, the system would be abnormal.</li>
 * </ul>
 *
 * @param  ptimer   [IN] timer handle.
 *
 * @retval  None.
 * @par Dependency:
 ...
 */
extern void init_timer(struct timer_list *ptimer);
