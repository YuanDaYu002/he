...
LITEOS_COPTS    += $(LITEOS_COPTS_BASE) $(LITEOS_COPTS_EXTRA)
LITEOS_COPTS_NODEBUG    += $(LITEOS_COPTS_BASE) $(LITEOS_COPTS_EXTRA)
LITEOS_COPTS_INTERWORK    += $(LITEOS_COPTS_BASE) $(LITEOS_COPTS_EXTRA_INTERWORK)
...
LITEOS_USR_INCLUDE = $(LITEOS_COMPAT_INCLUDE)  $(LITEOS_LIB_INCLUDE)

LITEOS_LIBDEP   += $(LITEOS_SCATTERLIB)  $(LITEOS_BASELIB)
...
LITEOS_LDFLAGS  += $(LITEOS_LD_OPTS)     $(LITEOS_LD_PATH) \
                   $(LITEOS_LD_SCRIPT)   $(LITEOS_TABLES_LDFLAGS)

LITEOS_MACRO = $(LITEOS_CMACRO)
