...
#define HIGMAC_TSO_SUPPORTED  //这个必须要选配。
...
#define HIGMAC_HWQ_RX_FQ_DEPTH    (1024)//暂时改为256测试用
...
struct higmac_desc {
    ...
    unsigned int skb_buff_addr;//我觉得应该把这个改造成保存m0 地址的，用来在释放的时候用。
...
extern struct higmac_netdev_local netdev_local;
