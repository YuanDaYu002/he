...
//#if (JFFS2NUM_JFFS2_GC_THREAD_STACK_SIZE >= JFFS2NUM_HAL_STACK_SIZE_MINIMUM)
//    char s_gc_thread_stack[JFFS2NUM_JFFS2_GC_THREAD_STACK_SIZE];
//#else
//    char s_gc_thread_stack[JFFS2NUM_HAL_STACK_SIZE_MINIMUM];
//#endif
    #define JFFS2NUM_JFFS2_GC_THREAD_STACK_SIZE  (1024*4)
    char s_gc_thread_stack[JFFS2NUM_JFFS2_GC_THREAD_STACK_SIZE];
...
#define jffs2_flash_read(c, ofs, len, retlen, buf) (spinor_mtd->read(c->mtd, ofs, len, retlen, buf))
