...
int ramfs_open     ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                             int mode,  ramfs_file *fte );
int ramfs_unlink   ( ramfs_mtab_entry *mte, UINT32 dir, const char *name );
int ramfs_mkdir    ( ramfs_mtab_entry *mte, UINT32 dir, const char *name );
int ramfs_rmdir    ( ramfs_mtab_entry *mte, UINT32 dir, const char *name );
int ramfs_rename   ( ramfs_mtab_entry *mte, UINT32 dir1, const char *name1,
                             UINT32 dir2, const char *name2 );
static int ramfs_link     ( ramfs_mtab_entry *mte, UINT32 dir1, const char *name1,
                             UINT32 dir2, const char *name2, int type );
int ramfs_opendir  ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                             ramfs_file *fte );
static int ramfs_chdir    ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                             UINT32 *dir_out );
int ramfs_stat     ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                             struct stat *buf);
static int ramfs_getinfo  ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                             int key, void *buf, int len );
static int ramfs_setinfo  ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                             int key, void *buf, int len );
...
int ramfs_fo_fstat     (struct RAMFS_FILE_TAG *fp, struct stat *buf );
...
typedef int     ramfs_fsop_open     ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                                    int mode,  ramfs_file *fte );
typedef int     ramfs_fsop_unlink   ( ramfs_mtab_entry *mte, UINT32 dir, const char *name );
typedef int     ramfs_fsop_mkdir    ( ramfs_mtab_entry *mte, UINT32 dir, const char *name );
typedef int     ramfs_fsop_rmdir    ( ramfs_mtab_entry *mte, UINT32 dir, const char *name );
typedef int     ramfs_fsop_rename   ( ramfs_mtab_entry *mte, UINT32 dir1, const char *name1,
                                    UINT32 dir2, const char *name2 );
typedef int     ramfs_fsop_link     ( ramfs_mtab_entry *mte, UINT32 dir1, const char *name1,
                                    UINT32 dir2, const char *name2, int type );
typedef int     ramfs_fsop_opendir  ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                                    ramfs_file *fte );
typedef int     ramfs_fsop_chdir    ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                                    UINT32 *dir_out );
typedef int     ramfs_fsop_stat     ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                                    struct stat *buf);
typedef int     ramfs_fsop_getinfo  ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                                    int key, void *buf, int len );
typedef int     ramfs_fsop_setinfo  ( ramfs_mtab_entry *mte, UINT32 dir, const char *name,
                                    int key, void *buf, int len );
...
struct ramfs_mtab_entry
{
    ...
    UINT32              root;           /** root directory pointer */
