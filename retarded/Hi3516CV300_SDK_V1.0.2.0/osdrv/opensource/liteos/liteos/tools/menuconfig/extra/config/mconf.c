...
inputbox_instructions_int[] =
	...
	"Use the Ctrl + Backspace key to delete your input.",
...
load_config_text[] =
	...
	"Ctrl + backbace can delete your input.",
load_config_help[] =
	"\n"
	"For various reasons, one may wish to keep several different LiteOS\n"
	"configurations available on a single machine.\n"
	"\n"
	"If you have saved a previous configuration in a file other than the\n"
	"LiteOS's default, entering the name of the file here will allow you\n"
...
save_config_help[] =
	"\n"
	"For various reasons, one may wish to keep different LiteOS\n"
	"configurations available on a single machine.\n"
	"\n"
...
int main(int ac, char **av)
{
	...
	sym_calc_value(sym);
	snprintf(menu_backtitle, 128, "LiteOS Configuration");
	...
	do {
		stat = dialog_yesno(NULL, 
				"Do you wish to save your new LiteOS configuration?", 5, 60);
	} while (stat < 0);
	end_dialog();
