...
drivers/usb
platform/cpu/arm/cortex-a7
platform/cpu/arm/cortex-a17
platform/cpu/arm/arm926
)
...
do
    ...
    do
        if [ ${dir} == "platform/cpu/arm/cortex-a7" ]
        then
            if [ ${cur_platform} != "hi3516a" ] && [ ${cur_platform} != "hi3559/cortex-a7" ]
            then
                continue
        ...
        if [ ${dir} == "platform/cpu/arm/arm926" ]
        then
        ...
        if [ ${dir} == "platform/cpu/arm/cortex-a17" ]
        then
            if [ ${cur_platform} != "hi3559/cortex-a17" ]
            then
                continue
...
rm -rf platform/cpu/arm/cortex-m3
rm -rf test/
rm -rf vendor/
