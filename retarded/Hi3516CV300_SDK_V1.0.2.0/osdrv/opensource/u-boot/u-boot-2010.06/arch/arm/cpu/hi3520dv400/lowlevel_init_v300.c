		...
		unsigned int iddq, unsigned int sel)
{
	if (sel == 0) {
		if (hpm <= 215)
			...
			writel(0x1100c7, CPU_VOL_REG);
		else if (hpm <= 264)
			writel(0x2b00c7, CPU_VOL_REG);
		else if (hpm <= 276)
			writel(0x3b00c7, CPU_VOL_REG);
		else
			writel(0x5000c7, CPU_VOL_REG);
	} else if (sel == 1) {
		if (hpm <= 216)
			writel(0x00c7, CORE_VOL_REG);
		else if (hpm <= 241)
			writel(0x1b00c7, CORE_VOL_REG);
		else if (hpm <= 257)
			writel(0x2f00c7, CORE_VOL_REG);
		else if (hpm <= 275)
			writel(0x3d00c7, CORE_VOL_REG);
		else
