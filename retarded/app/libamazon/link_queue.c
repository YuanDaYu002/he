...
int InLQueue(QHeader* qh,data_t* data)
{
    ...
    //pNode->data = data;
    memcpy(&pNode->data,data,sizeof(data_t));
...
int DeLQueue(QHeader* qh,data_t *pdata)
{
    ...
    qh->iNum--;     
    //*pdata = pDel->data;
    memcpy(pdata,&pDel->data,sizeof(data_t));
