			...
			if (0 > g_Session)
			{
				...
				if(1 == index )//0:Lan 1:是P2P连接     2:RLY
				{
					...
					*/
					...
					{	
						printf("PPCS_Write ok ! sizeof(STRUCT_OPEN_LIVING_REQUEST)(%d)bytes  write(%d)bytes\n",sizeof(STRUCT_OPEN_LIVING_REQUEST),ret);
		...
		else
		{
			...
			printf("into here 001\n");
				...
				*/
				...
				{	
					printf("PPCS_Write ok ! sizeof(STRUCT_SET_UPDATE_REQUEST)(%d)bytes  write(%d)bytes\n",sizeof(STRUCT_SET_UPDATE_REQUEST),ret);
